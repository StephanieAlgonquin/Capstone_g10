...
<div class="min-h-screen bg-[#1A1B23] text-white flex">
    ...
    <aside class="w-20 bg-[#252732] flex flex-col items-center py-6 border-r border-[#3A3B47]">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="mb-4 p-3 text-gray-400 hover:text-white hover:bg-[#353642] rounded-lg transition-colors" title="Dashboard">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
            </svg>
        </a>
        <a href="<?php echo e(route('calendar')); ?>" class="mb-4 p-3 text-white bg-[#353642] rounded-lg" title="Calendar">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <header class="bg-[#1A1B23] border-b border-[#3A3B47] px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 text-gray-300 hover:text-white hover:bg-[#252732] rounded transition-colors text-sm">
                        Dashboard
                    </a>
                </div>
            </div>
        ...
        <main class="flex-1 overflow-auto bg-[#1A1B23] p-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-3xl font-light text-white mb-2"><?php echo e($currentYear); ?> CALENDAR</h1>
                </div>
                ...
                <div class="bg-[#2D2E3A] border border-[#3A3B47] rounded-lg overflow-hidden">
                    ...
                    <div class="bg-[#252732] border-b border-[#3A3B47] px-6 py-4">
                        <h2 class="text-2xl font-semibold text-white uppercase tracking-wide"><?php echo e($monthName); ?></h2>
                    </div>

                    <!-- Day Headers (Monday to Sunday) -->
                    <div class="grid grid-cols-7 border-b border-[#3A3B47] bg-[#252732]">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="grid grid-cols-7">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="min-h-[120px] p-3 border-r border-b border-[#3A3B47] last:border-r-0 bg-[#2D2E3A] hover:bg-[#353642] transition-colors">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dayData === null): ?>
                                <div class="text-gray-600 text-sm"></div>
                            <?php else: ?>
                                <div class="mb-2">
                                    <span class="text-lg font-medium <?php echo e($dayData['isToday'] ? 'text-white bg-purple-600 rounded-full w-8 h-8 flex items-center justify-center' : 'text-gray-300'); ?>">
                                        <?php echo e($dayData['day']); ?>

                                    </span>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($dayData['tasks']) > 0): ?>
                                <div class="space-y-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice($dayData['tasks'], 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="text-xs text-gray-400 truncate px-1 py-0.5 rounded
                                        <?php echo e($task->priority === 'high' ? 'bg-red-500/20 text-red-300' : ($task->priority === 'medium' ? 'bg-yellow-500/20 text-yellow-300' : 'bg-green-500/20 text-green-300')); ?>">
                                        <?php echo e($task->title); ?>

                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(count($dayData['tasks']) > 3): ?>
                                    <div class="text-xs text-gray-500 px-1">
                                        +<?php echo e(count($dayData['tasks']) - 3); ?> more
                                    </div>
...
<?php /**PATH C:\Users\sarat\Herd\Capstone_g10\resources\views/livewire/calendar.blade.php ENDPATH**/ ?>