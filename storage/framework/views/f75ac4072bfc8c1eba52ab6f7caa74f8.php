        ...
        <header class="bg-[#1A1B23] border-b border-[#3A3B47] px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center justify-center w-15 h-1  rounded-lg">
                        <img src="<?php echo e(asset('resources/css/capstone_logo.svg')); ?>" alt="Logo" class="w-10 h-10 rounded-full object-cover">
                    </div>
                    <div>
...
<?php /**PATH C:\Users\kiarash\Herd\capstone\resources\views/livewire/task-manager.blade.php ENDPATH**/ ?>