...
<body class="bg-[#1A1B23] text-white">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Registration Form -->
            <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm" class="mt-8 space-y-6 bg-[#2D2E3A] border border-[#3A3B47] p-8 rounded-lg shadow-lg" novalidate>
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Stephanie\OneDrive\Stephanie\Desktop (1)\semester4\php\capstone\capstone\resources\views/auth/register.blade.php ENDPATH**/ ?>