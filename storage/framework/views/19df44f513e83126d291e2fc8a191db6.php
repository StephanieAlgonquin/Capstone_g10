        ...
        <main class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
            <div class="max-w-5xl mx-auto text-center">
                ...
                <p class="text-lg sm:text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                    TaskFlow helps you stay organized with intuitive task lists, priority management, and seamless collaboration. 
        ...
        <footer class="bg-[#252732] border-t border-[#3A3B47] py-8 mt-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-center">
                    <p class="text-gray-400 mb-4 sm:mb-0">© <?php echo e(date('Y')); ?> TaskFlow. Built with Laravel & Livewire.</p>
...
<?php /**PATH C:\Users\sarat\Herd\Capstone_g10\resources\views/welcome.blade.php ENDPATH**/ ?>